...
function slide_effect_callback(){ ?>
    <div>
        <select name="slide-effect" id="slide-effect">
            <option value="1">Normal</option>
            <option value="2">Slide eff 2</option>
            <option value="3">Slide eff 3</option>
        </select>
    </div>
<?php }