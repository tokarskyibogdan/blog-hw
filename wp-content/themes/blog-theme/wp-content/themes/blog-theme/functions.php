...
function theme_color() { ?>
    <style type="text/css">
        ...
        .widget_recent_entries .nav li:hover,
        .elp-widget input[type=button],
        .contact-aside .contact-phone-number,
        ...
        {
            background-color: <?php echo get_theme_mod('theme-color-picker'); ?>;
        }

        .blog-name-left {
            color: <?php echo get_theme_mod('theme-color-picker'); ?>;
        }

        .slide-content {
            border-top: 4px solid <?php echo get_theme_mod('theme-color-picker'); ?>;
        }
    </style>
<?php }
